...
public class Teste {
	...
	public static void main (String[] arg) {
		...
		repoUsers.getUsuarioPeloNome(testeUser.getNome()).getCalendar().buscarPorNome("Evento de teste").toString();
		...
		repoUsers.getUsuarioPeloNome(testeUser.getNome()).getCalendar().buscarPorNome("Evento de teste sendo testado").toString();
