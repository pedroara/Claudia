...
public class ControllerClaudiaRemoverEventos {
	    ...
	    void selecionarEvento(MouseEvent event) {
	    	 ...
	    	 removerBtn.setOnAction(new EventHandler<ActionEvent>() { @Override public void handle(ActionEvent event) {  fachadaClaudia.remover(selecionado);  evSelecionado.setText("Evento removido!");} } );
